...
const Home = () => {
  ...
  const { data: videos, error, isLoading } = useSWR(
    `/videos?page=${page}&limit=12&sortBy=createdAt&sortType=desc`,
    fetcher
  );
    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="bg-gradient-to-r from-secondary to-card p-8 mb-12">
        <div className="max-w-7xl mx-auto">
          <h1 className="text-4xl font-bold text-accent mb-2">Welcome to VideoHub</h1>
          <p className="text-muted-foreground text-lg">
            Discover amazing videos from creators worldwide
          </p>
        </div>
      </div>
